 ...
 */
/*
 * Extends RedisCache with new methods exposing Redis data structures.  Chose not to inherit from
 * RedisCache to preserve private variables.
 */
public class RedisCacheExtended<K, V> implements CacheWithLifetimes<K, V> {
     ...
     * 
     * */
    public RedisCacheExtended(String host, long defaultLifespan) {
     ...
     * 
     * */
    public RedisCacheExtended(String host, int port, long defaultLifespan) {
     ...
     * 
     * */
    public RedisCacheExtended(String host, int port, int timeout, long defaultLifespan) {
     ...
     * 
     * */
    public RedisCacheExtended(Jedis jedisCache, long defaultLifespan) {
        cache = jedisCache;
        defaultLifetime = defaultLifespan;
    }
