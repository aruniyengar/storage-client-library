...
public class SampleCache2 {
	...
	public static <T> T find(Class<T> classType, String id, LoadingCache<String,
			Object> cache1)  throws Exception {
		return classType.cast(cache1.get(id));
	}

	public static void store(Object obj, String id, LoadingCache<String,
			Object> cache1)  throws Exception {
		cache1.put(id, obj);
	}
