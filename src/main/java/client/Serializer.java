...
public class Serializer {
	...
	public static <T> T deserializeFromDisk(String filename){
		...
		{
			System.out.println("datalake.util.Serializer.y.deserializeFromDisk: class not found");
			c.printStackTrace();
			return null;
		}
	...
	public static <T> T deserializeFromByteArray(byte[] bytes){
		...
		{
			System.out.println("datalake.util.Serializer.deserializeFromByteArray: class not found");
			c.printStackTrace();
			return null;
		} finally {
		  try {
	...
	public static void byteArrayToFile(byte[] data, String filename) throws Exception {
	...
	public static void printByte(byte x) {
		// good way to convert byte to nonnegative integer between 0 and 255 inclusive
		System.out.println("byte value: " + x + ", long value: " + (long) (x + 128));		
	}
	...
	private static <T> T deserializeFromStream(ObjectInputStream in) {
		...
		try {
			...
			System.out.println("Error: Class not found in datalake.util.Serializer.deserializeFromStream");
			c.printStackTrace();
			return null;
		}
		return r;
	...
	public static void main(String[] args) {
		...
		System.out.println("Here is the data deserialized from the byte array ");
		outputData(r3);
		outputData(r4);
		outputData(r5);
		
		System.out.println("test of serializing/deserializing single object in one command");
