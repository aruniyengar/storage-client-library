...
public class OtherProcessCache<K,V> {
	...
	/**
     * Return BinaryJedis data structure so users can make direct API calls to it
     *
     * @return 
     * 		BinaryJedis data structure corresponding to underlying cache
     * 			
     * */
	...
	public static void test3() {
		OtherProcessCache<String,HashMap<String,Integer>> opc = new 
				OtherProcessCache<String,HashMap<String,Integer>>("localhost", 6379, 60);
		String key1 = "key1";
		String key2 = "key2";
		String key3 = "key3";
		try {
	...
	public static void test2() {
		OtherProcessCache<String,String> opc = new OtherProcessCache<String,String>("localhost", 6379, 60);
		String key1 = "foo";
		String key2 = "bar";
